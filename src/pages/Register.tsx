    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-background to-secondary/30">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-foreground">ISO Audit Pro</h1>
          <p className="text-muted-foreground mt-1">Gestión de auditorías ISO</p>
        </div>

        <Card className="shadow-elevated border-0">
          <CardHeader className="text-center pb-4">
            <CardTitle className="text-xl font-display">Crear Cuenta</CardTitle>
